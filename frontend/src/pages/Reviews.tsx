...
const Reviews: React.FC = () => {
  ...
  const writeTotalPages = Math.max(
    1,
    Math.ceil(filteredHasReadBooks.length / writeBooksPerPage)
  );
        ...
        <section className="reviews-section">
          ...
          <div className="reviews-toolbar">
            ...
            <button
              ...
              type="button"
              onClick={() => searchReviewedBooks(searchText)}
            >
              Search
            </button>
          </div>
            ...
            {reviewedBooks.map((book) => (
              <div
                ...
                className={`reviews-book-chip ${
                  selectedBook?._id === book._id ? "reviews-book-chip--selected" : ""
                }`}
                onClick={() => {
                  closeWritePanel();
              ...
              <div className="reviews-book-search-results">
                {paginatedHasReadBooks.map((book) => (
                  <div
                    key={book._id}
                    className={`reviews-book-chip ${
                      selectedHasReadBook?._id === book._id
                        ? "reviews-book-chip--selected"
                        : ""
                    }`}
                    onClick={() => {
                      closeViewPanel();
          ...
          {selectedHasReadBook && (
            <div className="reviews-create-card">
              <div className="reviews-panel-header">
                <div>
                  <div className="reviews-create-card__book">
                    {selectedHasReadBook.title}
                  </div>
                ...
                <div className="reviews-book-card__inner">
                  ...
                  <div>
                    ...
                    <div className="reviews-book-card__avg">
                      ...
                      {" · "}
                      {viewData.reviewCount} review
                      {viewData.reviewCount !== 1 ? "s" : ""}
                    </div>
                  </div>
                </div>
