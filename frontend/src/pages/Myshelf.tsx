  ...
  <div className="shelf-book">
    ...
    <div className="shelf-book__info">
      ...
      <div style={{ display: "flex", gap: "0.5rem", flexWrap: "wrap", marginTop: "0.75rem" }}>
        <button type="button" onClick={() => onMove("hasRead")}>Has read</button>
        <button type="button" onClick={() => onMove("reading")}>Reading</button>
        <button type="button" onClick={() => onMove("wantsToRead")}>Want to read</button>
